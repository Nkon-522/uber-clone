    ...
    <div id="Home" class="flex flex-col h-screen">
      ...
      >
        <div class="grid place-items-center">
          ...
          <div class="w-full -mt-1 text-xs text-center text-gray-800 font-semibold">Home</div>
        </div>

        <div class="grid place-items-center">
          <MapMarkerIcon :size="30" fillColor="#b3b1b1"/>
          <div class="w-full -mt-1 text-xs text-center text-gray-400 font-semibold">Destination</div>
        </div>
